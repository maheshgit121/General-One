...
public class TC001 {
	...
	public void reportname()
	{
		...
		spark = new ExtentSparkReporter("reports/SmokeReportOn"+DateFormat+".html"); //creates html report to print the logs created by extent reports
	...
	public void setlogger(String c)
	{
		...
		System.setProperty("file.name", "smoke");
